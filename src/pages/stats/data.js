...
export const statsSrc = [
   {
      title: 'Объем средств российского банковского сектора, размещенных на кор.счетах ностро в кред.организациях за рубежом, на начало года\n(в млрд. руб.)',
      darkImg: dark_stats_1,
      lightImg: light_stats_1,
   },
   {
      title: 'Предоставленные кредиты, сделки обратного РЕПО, субординированные кредиты российского банковского сектора, размещенные в кредитных организациях за рубежом\n(в млрд. руб.)',
   ...
   {
      title: `Объем средств зарубежных банков, привлеченных рос.банк.сектором на кор.счета\n(в млрд. руб.)`,
      darkImg: dark_stats_4,
      lightImg: light_stats_4,
   },
   {
      title: 'Привлеченные рос.банковским сектором кредиты и депозиты, а также сделки прямого РЕПО и субординированные кредиты\n(в млрд. руб.)',
